...
Dokumen ini memuat arsitektur teknis dan implementasi kode Python untuk mengekstrak **68 fitur deret waktu terstandar** menggunakan pustaka **TSFEL** (*Time Series Feature Extraction Library*) khusus untuk parameter **$\text{NO}_2$** di **Kecamatan Jabon, Kabupaten Sidoarjo** sesuai ketentuan Tugas 3.
...
*   **Output Berkas**: `NO2_Jabon_TSFEL.csv`.
...
# ---------- 1. Muat dan Bersihkan Data (Kecamatan Jabon) ----------
csv_path = 'data/downloads/jabon_pollutants_data/jabon_NO2.csv'
...
# Simpan hasil ekstraksi fitur untuk wilayah Kecamatan Jabon
output_csv = f'{target_pollutant}_Jabon_TSFEL.csv'
